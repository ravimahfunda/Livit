...
public class NutriotionsProvider extends ContentProvider {
    ...
    public Cursor query(@NonNull Uri uri, @Nullable String[] projection, @Nullable String selection,
        ...
        switch (match){
            case NUTRITIONS :{
                cursor = db.query(NutritionsContract.NutritionsEntry.TABLE_NAME, projection,
                        selection, selectionArgs,null,null,sortOrder);
                break;
            }
            case NUTRITIONS_ID : {
                selection = NutritionsContract.NutritionsEntry._ID + "=?";
    ...
    private Uri insertPet(Uri uri, ContentValues values) {
        Integer carbs = values.getAsInteger(NutritionsContract.NutritionsEntry.COLUMN_NUTRITIONS_CARBS);
        ...
        if (vegetable == null || !NutritionsEntry.isValidVegetable(vegetable)) {
        ...
        long id = db.insert(NutritionsContract.NutritionsEntry.TABLE_NAME, null, values);
        if (id == -1) {
